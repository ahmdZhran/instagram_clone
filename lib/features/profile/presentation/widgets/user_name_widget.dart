...
//         if (state is ProfileLoading || profileCubit.userProfileData == null) {
...
//           return Text(
//             "Failed to load user",
//             style: CustomTextStyle.pacifico25.copyWith(color: Colors.red),
//           );
//         } else if (state is ProfileSuccess &&
//             profileCubit.userProfileData != null) {
